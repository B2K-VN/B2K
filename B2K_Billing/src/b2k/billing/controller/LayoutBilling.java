...
public class LayoutBilling extends JPanel {
	...
	private JPanel pnSearch = null; // @jve:decl-index=0:visual-constraint="290,0"
	private MyLabel lblSearch = null;
	private MyTextField txtPatientID = null;
	private MyButton btnSearch = null;

	/**
	 * This is the default constructor
	 */
	public LayoutBilling() {
		super();
		initialize();
	}
	 ...
	 */
	public int si = 20;
	private JLabel lblEmp1 = null;  //  @jve:decl-index=0:visual-constraint="599,620"
	 ...
	 */
	private MyTextField getTxtPatientID() {
		if (txtPatientID == null) {
			txtPatientID = new MyTextField(14f);
		}
		return txtPatientID;
	}
